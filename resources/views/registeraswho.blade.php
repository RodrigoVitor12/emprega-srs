...
@section('title', 'Entrar como - MaoNaVaga')
    ...
    <div class="py-12">
        ...
        <div class="flex flex-col md:flex-row gap-12 justify-center items-center text-center my-8 flex-wrap">
            <a href="{{ route('register-candidate') }}"
                class="bg-white p-6 rounded-md shadow-2xl hover:shadow-xl  flex flex-col justify-center">
            ...
            <a href="{{ route('register-company') }}"
                class="bg-white p-6 rounded-md shadow-2xl hover:shadow-xl flex flex-col justify-between">
