...
@section('title', 'Sobre Nós - MaoNaVaga')
    ...
    <section class="px-4">
        ...
        <article class="py-12 flex flex-col md:flex-row items-center">
            <div>
                ...
                <h2 class="font-bold mt-4 text-2xl text-[#155DFC]">Transformar Santa Rita do Sapucaí em um polo de inovação
                    profissional</h2>
                <div class="mt-4 md:w-[50%] text-gray-600 text-xl">
                    <p>
                        Acreditamos que todo talento da nossa cidade merece ter acesso a oportunidades que realmente façam a
                        diferença em sua carreira e no crescimento da comunidade. Por isso, criamos uma plataforma pioneira,
                        que vai além de simplesmente listar vagas.
                    </p>
                    <br>
                    <p>
                        Conectamos candidatos a empresas locais de forma transparente e eficiente, oferecendo informações
                        sobre cultura organizacional, oportunidades de desenvolvimento e benefícios, para que cada decisão
                        profissional contribua para o fortalecimento da cidade e para o futuro de quem nela vive.
                    </p>
                </div>
            </div>
