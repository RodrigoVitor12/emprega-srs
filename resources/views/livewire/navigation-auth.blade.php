...
<nav x-data="{ open: false }" class="bg-[#155DFC] shadow-md">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (auth()->user()->role == 0)
                        <x-nav-link :href="route('admin.index')" :active="request()->routeIs('dashboard')" wire:navigate>
                            {{ __('Admin') }}
                        </x-nav-link>
                    @endif
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open"
                    class="inline-flex items-center justify-center p-2 rounded-md  focus:outline-none text-white focus:bg-gray-100 dark:focus:bg-blue-900 focus:text-gray-500 dark:focus:text-gray-400 transition duration-150 ease-in-out">
