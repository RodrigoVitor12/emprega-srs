<footer class="px-4 bg-[#315EFD] py-4 text-white">
        <div class="grid md:grid-cols-3 gap-8 mb-2 md:ml-44">
            <div>
                <p class="mb-3 text-2xl font-bold"><ion-icon name="search-outline"></ion-icon> MeuSite</p>
                <p class="mb-3 text-md">Conectando talentos com as melhores oportunidades <br> de emprego em Santa Rita do Sapucaí</p>
        ...
        <div class="mt-3 flex justify-around">
            <p class="text-md">&copy; MeuSite. Todos os direitos reservados.</p>
